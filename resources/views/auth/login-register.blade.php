...
@push('scripts')
    ...
    <script src="{{ asset('js/site-logo.js') }}"></script>
            ...
            <div class="form-stage">
                ...
                <section class="form-panel login-panel" aria-labelledby="login-title">
                    <form id="loginForm" class="auth-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="social-row" aria-label="Social login options">
                            <button type="button" class="social-button" data-provider="Google" aria-label="Continue with Google">
                            ...
                            <button type="button" class="social-button" data-provider="Facebook" aria-label="Continue with Facebook">
                                <svg viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill="currentColor" d="M22 12.06C22 6.48 17.52 2 11.94 2S2 6.48 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.52 1.5-3.91 3.79-3.91 1.1 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56v1.9h2.77l-.44 2.91h-2.33V22A10.02 10.02 0 0 0 22 12.06z"/>
                                </svg>
                            </button>
                            <button type="button" class="social-button" data-provider="GitHub" aria-label="Continue with GitHub">
                                <svg viewBox="0 0 24 24" aria-hidden="true">
                ...
                <section class="form-panel register-panel" aria-labelledby="register-title">
                    <form id="registerForm" class="auth-form" method="POST" action="{{ route('register') }}">
                        ...
                        <p class="password-hint" id="passwordHint">Use at least 8 characters with 3 special characters.</p>
