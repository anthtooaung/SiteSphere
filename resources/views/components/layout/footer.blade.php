        ...
        <div class="grid grid-cols-1 gap-12 border-b border-slate-800 pb-12 sm:grid-cols-2 lg:grid-cols-3">
            <div class="text-center sm:text-left">
                ...
                <ul class="flex flex-col items-center gap-3.5 text-sm sm:items-start">
                    ...
                    <li>
                        <a href="{{ auth()->check() ? route('posts.create') : route('login') }}" class="group flex items-center gap-2.5 py-0.5 text-slate-400 transition-all duration-300 hover:translate-x-1.5 hover:text-white">
