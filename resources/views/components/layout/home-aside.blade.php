...
"
class="{{ $isDropdownAside ? 'md:w-full md:flex md:justify-center' : 'md:h-full' }}">
    ...
    >
        ...
        @if ($isDropdownAside)
            <div class="linear-filter-bar flex items-center justify-center gap-4 w-full mx-auto px-4">
                <div class="sidebar-section home-aside-dropdown" x-data="{ openSection: false }" @click.outside="openSection = false">
                    ...
                    <div class="section-content" id="ratingContent" x-show="openSection" x-cloak>
                ...
                <div class="sidebar-section home-aside-dropdown" x-data="{ openSection: false }" @click.outside="openSection = false">
                    ...
                    <div class="section-content" id="categoryContent" x-show="openSection" x-cloak>
                ...
                <div class="sidebar-section home-aside-dropdown" x-data="{ openSection: false }" @click.outside="openSection = false">
                    ...
                    <div class="section-content" id="tagsContent" x-show="openSection" x-cloak>
                        <div class="tag-tools">
