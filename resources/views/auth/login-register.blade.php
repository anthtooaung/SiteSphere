                ...
                <section class="form-panel login-panel" aria-labelledby="login-title">
                    <form id="loginForm" class="auth-form" method="POST" action="{{ route('login.store') }}">
                        ...
                        <div class="social-row">
                            <button type="button" class="social-button" id="googleConnectBtn">
                            ...
                            <button type="button" class="social-button" id="facebookConnectBtn">
                                <svg viewBox="0 0 24 24" aria-hidden="true">
                            ...
                            <button type="button" class="social-button" id="githubConnectBtn">
                                <svg viewBox="0 0 24 24" aria-hidden="true">
