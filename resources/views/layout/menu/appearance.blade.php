                ...
                x-data="{
                    ...
                    async submitForm(formElement) {
                        ...
                        const result = await Swal.fire({
                            title: 'Save Changes?',
                            text: 'Are you sure you want to apply these appearance settings?',
                            icon: 'question',
                    ...
                    <div class="appearance-theme-grid" :class="{ 'is-disabled': useCustomTheme }">
                        @foreach ($presetThemes as $presetTheme)
                            <label class="appearance-theme-option">
                                ...
                                <span class="appearance-check-badge" aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/></svg>
                                </span>
                            </label>
                        @endforeach
                    </div>
